<div align="center">
  ...
  [![My613](./public/img/media.png)](https://my613.com)

</div>

This is the main monorepo codebase of [My613](https://my613.com). Every single line of code that's not packaged into a reusable library is in this repository.
...
My613 has been under full-time development since March, 2017. See [the roadmap](https://github.com/planeight/my613/projects/19) for up-to-date information about our current areas of focus.
...
- [Contributing](#contributing)
  ...
  - [Roadmap](https://github.com/planeight/my613/projects/19)
- [Technical](docs/)
...
**We heartily welcome any and all contributions that match [our product roadmap](https://github.com/planeight/my613/projects/19) and engineering standards!**
...
All conversations and communities on My613 agree to our underlying [code of conduct](https://github.com/planeight/code-of-conduct). This code of conduct also applies to all conversations that happen within our contributor community here on GitHub. We expect discussions in issues and pull requests to stay positive, productive, and respectful. Remember: there are real people on the other side of that screen!

#### Reporting a bug or discussing a feature idea

If you found a technical bug on My613 or have ideas for features we should implement, the issue tracker is the best place to share your ideas. Make sure to follow the issue template and you should be golden! ([click here to open a new issue](https://github.com/planeight/my613/issues/new))

#### Fixing a bug or implementing a new feature

If you find a bug on My613 and open a PR that fixes it we'll review it as soon as possible to ensure it matches our engineering standards. If you want to implement a new feature, open an issue first to discuss what it'd look like and to ensure it fits in [our roadmap](https://github.com/planeight/my613/projects/19) and plans for the app.

If you want to contribute but are unsure to start, we have [a "good first issue" label](https://github.com/planeight/my613/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) which is applied to newcomer-friendly issues. Take a look at [the full list of good first issues](https://github.com/planeight/my613/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) and pick something you like! There is also [an "open" channel in the My613 community on My613](https://my613.com/my613/open) (how meta), if you run into troubles while trying to contribute that is the best place to talk to us.
...
My613/
├── api        # API server
├── notification-worker     # Worker server (notifications and general processing)
├── cronjob-worker    # Worker server (cron jobs)
├── desktop    # desktop apps (build with electron)
├── docs
├── email-templates
├── email-worker     # Worker server (email sending)
├── ssr-server   # Server rendering server
├── reputation-worker    # Worker server (reputation)
├── public     # Public files used on the frontend
├── shared     # Shared JavaScript code
├── src        # Frontend SPA
└── search-worker     # Worker server (search indexing; syncing with Algolia)
```
...
The first step to running My613 locally is downloading the code by cloning the repository:

```sh
git clone git@github.com:planeight/My613.git
```
 If you get `Permission denied` error using `ssh` refer [here](https://help.github.com/articles/error-permission-denied-publickey/)
or use `https` link as a fallback.
```sh
git clone https://github.com/planeight/My613.git
```

#### Installation

My613 has four big installation steps:
...
> Note: If you're an employee at My613 we've got a more complete list of secrets that also lets you upload images etc. in 1Password, search for "now-secrets.json" to find it.
...
Whenever you want to run My613 locally you have to have RethinkDB and Redis running in the background. First start rethinkdb like we did to migrate the database:
...
Depending on what you're trying to work on you'll need to start different servers. Generally, all servers run in development mode by doing `yarn run dev:<workername>`, e.g. `yarn run dev:email-worker` to start the email worker.
